...
# Stochastic Oscillator Plot
    ...
    st.image(r"C:\Users\srikr\Desktop\COLLEGE\Sem 4\FE\FE Project\stoc.jpg", caption="Stocastic Oscillator", use_column_width=True)
    if 'data' in st.session_state:
...
# Rate of Change (ROC) Plot
    ...
    st.image(r"C:\Users\srikr\Desktop\COLLEGE\Sem 4\FE\FE Project\roc.jpg", caption="ROC", use_column_width=True)
    if 'data' in st.session_state:
        analyzed_data = calculate_technical_indicators(st.session_state.data)
        fig, ax1 = plt.subplots(figsize=(12, 8))
...
# Relative Strength Index (RSI) Plot
    ...
    st.image(r"C:\Users\srikr\Desktop\COLLEGE\Sem 4\FE\FE Project\rsi.jpg", caption="RSI", use_column_width=True)
    if 'data' in st.session_state:
        analyzed_data = calculate_technical_indicators(st.session_state.data)
        fig, ax1 = plt.subplots(figsize=(12, 8))
...
# MACD Plot
    ...
    st.image(r"C:\Users\srikr\Desktop\COLLEGE\Sem 4\FE\FE Project\macd.jpg", caption="MACD", use_column_width=True)
    if 'data' in st.session_state:
        analyzed_data = calculate_technical_indicators(st.session_state.data)
        fig, ax1 = plt.subplots(figsize=(12, 8))
    ...
    st.image(r"C:\Users\srikr\Desktop\COLLEGE\Sem 4\FE\FE Project\analysis.jpg", caption="Conditions", use_column_width=True)
    if 'data' in st.session_state:
        analyzed_data = calculate_technical_indicators(st.session_state.data)
    ...
    st.image(r"C:\Users\srikr\Desktop\COLLEGE\Sem 4\FE\FE Project\note.jpg", caption="NOTE", use_column_width=True)
    if 'data' in st.session_state:
